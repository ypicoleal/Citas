...
class CitaMedica(models.Model):
    ...
    def modalidad(self):
        if self.procedimiento.modalidad == 1:
            return "Consultorio"
        # end if
        return "Virtual"
    # end def
...
class PagoCita(models.Model):
    cita = models.ForeignKey(CitaMedica, blank=True, null=True)
    fecha = models.DateTimeField(auto_now_add=True)
    merchantId = models.IntegerField()
    state_pol = models.CharField("Indica el estado de la transacción en el sistema.", max_length=32)
